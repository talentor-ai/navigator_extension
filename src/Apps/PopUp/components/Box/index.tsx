...
const Box = (props: iProps) => {
  ...
  switch (boxType) {
    case 'button':
      return (
        <button id={id} style={style} className={classBuilder}>
          {children}
        </button>
      );
    case 'input':
    ...
    case 'icon':
      return (
        <div id={id} style={style} className={classBuilder}>
          {children}
        </div>
      );
    case 'navLink':
    ...
    default:
      return (
        <div id={id} style={style} className={classBuilder} onClick={onClick}>
          {children}
        </div>
      );
  }
